...
import com.jd.lib.asmplugin.Controller
import com.jd.lib.asmplugin.AutoMethodVisitor
import com.jd.lib.asmplugin.Logger
...
class ChoiceUtil {
    ...
    static MethodVisitor getMethodVisitor(String[] interfaces, String className,
        ...
        if (name == "onClick" && isMatchingInterfaces(interfaces, 'android/view/View$OnClickListener')) {
            ...
            adapter = new AutoMethodVisitor(methodVisitor, access, name, desc) {
                ...
                protected void onMethodEnter() {
                    ...
                    methodVisitor.visitVarInsn(25, 1)
                    // INVOKESTATIC 184
                    methodVisitor.visitMethodInsn(184, "com/jd/lib/asmdextest/AutoHelper", "onCreateYaHa", "()V", false)
                }
            }
        ...
        } else if (name == "initNum" && className.contains("Activity")) {
            adapter = new AutoMethodVisitor(methodVisitor, access, name, desc) {
                @Override
                protected void onMethodExit(int opcode) {
                    super.onMethodExit(opcode)
                    ...
                    // INVOKESTATIC 184
                    methodVisitor.visitMethodInsn(184, "com/jd/lib/asmdextest/AutoHelper", "onGetData", "(I)V", false)

                }
            }
        } else if (name == "initText" && className.contains("Activity")) {
            adapter = new AutoMethodVisitor(methodVisitor, access, name, desc) {
                @Override
                protected void onMethodExit(int opcode) {
                    super.onMethodExit(opcode)
                    ...
                    methodVisitor.visitVarInsn(25, 0)
                    // INVOKESTATIC 184
                    methodVisitor.visitMethodInsn(184, "com/jd/lib/asmdextest/AutoHelper", "onGetContent", "()V", false)
