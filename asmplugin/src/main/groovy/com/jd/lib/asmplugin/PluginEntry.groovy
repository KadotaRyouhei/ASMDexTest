...
import com.jd.lib.asmplugin.AutoClassFilter
import com.jd.lib.asmplugin.TextUtil
import com.jd.lib.asmplugin.AppSettingParams
import com.jd.lib.asmplugin.AutoTransform
...
class PluginEntry implements Plugin<Project> {
    ...
    void apply(Project project) {
        System.out.println("========================");
        System.out.println("hello gradle plugin ASM Version!!!");
        System.out.println("========================");
